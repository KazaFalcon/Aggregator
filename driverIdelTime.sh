...
sleep 60
curl -X POST -i -H "Content-type: application/json" -X POST http://0f8202c8526b4c35aae76a654dd1e0a1.cloudapp.net/api/AgreegatorController/AddAggregatorParkingTime -d '
    {
